...
# ==========================================
TOKEN = "8919413615:AAGoHZkeQbA3NmxCqR8Zd4MOhjCSyOuXWb0"
...
def mask_num_for_group(num):
    """OTP group-এ masked number: +2250яσмαη2223"""
    clean = num.replace(" ", "")
    prefix = "+" if clean.startswith("+") else ""
    digits = clean[1:] if prefix else clean
    if len(digits) > 9:
        return f"{prefix}{digits[:6]}яσмαη{digits[-3:]}"
    elif len(digits) > 5:
        return f"{prefix}{digits[:3]}яσмαη{digits[-2:]}"
    return clean
...
def main_menu(user_id):
    kb = [
        ...
        [
            {"text": "𝐁𝐔𝐘 𝐍𝐔𝐌𝐁𝐄𝐑", "icon_custom_emoji_id": "5807623703562817982", "style": "primary"},
            {"text": "𝐋𝐢𝐯𝐞 𝐒𝐮𝐩𝐩𝐨𝐫𝐭", "icon_custom_emoji_id": "6303091998412770070", "style": "primary"}
        ],
        [
            {"text": "𝐑𝐞𝐟𝐞𝐫𝐫𝐚𝐥", "icon_custom_emoji_id": "6271293954633766411", "style": "primary"},
            {"text": "𝐖𝐢𝐭𝐡𝐝𝐫𝐚𝐰𝐚𝐥", "icon_custom_emoji_id": "6217469007868465305", "style": "primary"}
        ],
    ]
    if is_admin(user_id): 
...
def system_settings_keyboard():
    return {"inline_keyboard": [
        ...
        [{"text": "Force Join System", "icon_custom_emoji_id": "5420517437885943844", "callback_data": "manage_fj", "style": "primary"},
         {"text": "OTP Group", "icon_custom_emoji_id": "6271371418663917390", "callback_data": "manage_otp_groups", "style": "danger"}],
        ...
        [{"text": "Premium Emoji", "icon_custom_emoji_id": "5352552689983067014", "callback_data": "manage_emojis", "style": "success"},
         {"text": "ROMAN CONTROL", "icon_custom_emoji_id": "6264695922794435129", "callback_data": "dxa_control", "style": "primary"}],
